  ...
  return (
    <div>
      ...
      <div className="notice">
        ...
        client has a blended report plus separate Meta and Google channel reports
        with spend, conversions, CPA/ROAS, campaigns, and AI recommendations.
        Share inside the team PIN gate for now; external magic links can come next.
      </div>
      ...
      <div className="grid two">
        {data.clients.map((c) => {
          ...
          return (
            <div key={c.client.id} className="card report-card">
              <Link
              ...
              <div className="report-channel-actions">
                ...
                <Link
                  className="btn primary small"
                  href={`/reports/${c.client.slug}/meta?range=${range}`}
                >
                  Meta
                </Link>
                <Link
                  className="btn primary small"
                  href={`/reports/${c.client.slug}/google?range=${range}`}
                >
                  Google
                </Link>
              </div>
